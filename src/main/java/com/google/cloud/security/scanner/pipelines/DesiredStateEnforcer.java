...
import com.google.cloud.security.scanner.actions.messengers.DiscrepancyAutoFixMessenger;
...
public class DesiredStateEnforcer {
   ...
   */
  public DesiredStateEnforcer attachSink(PTransform<PCollection<String>, PDone> sinkTransform) {
   ...
   */
  DesiredStateEnforcer appendAssertContains(String[] expectedOutputs) {
